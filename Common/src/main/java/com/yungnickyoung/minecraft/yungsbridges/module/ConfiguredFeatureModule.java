...
public class ConfiguredFeatureModule {
    ...
    public static final ConfiguredFeature<?, ?> BRIDGE_LIST_FEATURE_CONFIGURED =
            new ConfiguredFeature<>(FeatureModule.MULTIPLE_ATTEMPT_SINGLE_RANDOM, new MultipleAttemptSingleRandomFeatureConfig(PLACED_BRIDGES));
    ...
    private static void registerConfiguredFeature(ConfiguredFeature<?, ?> feature, String id) {
        Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, new ResourceLocation(YungsBridgesCommon.MOD_ID, id), feature);
    }

    private static void registerPlacedFeature(PlacedFeature feature, String id) {
        Registry.register(BuiltinRegistries.PLACED_FEATURE, new ResourceLocation(YungsBridgesCommon.MOD_ID, id), feature);
    }

    /**
     * Utility methods for registering bridge variants.
     */

    private static void addLargeBridge(String id, BridgePlacementConfig placementConfig) {
        addBridge(id, placementConfig, YungsBridgesCommon.CONFIG.spawnRates.largeBridges);
    }

    private static void addMediumBridge(String id, BridgePlacementConfig placementConfig) {
        addBridge(id, placementConfig, YungsBridgesCommon.CONFIG.spawnRates.mediumBridges);
    }

    private static void addSmallBridge(String id, BridgePlacementConfig placementConfig) {
        addBridge(id, placementConfig, YungsBridgesCommon.CONFIG.spawnRates.smallBridges);
    }
    ...
    private static void addBridge(String id, BridgePlacementConfig placementConfig, int chance) {
        ...
        ConfiguredFeature<?, ?> configuredFeature = new ConfiguredFeature<>(FeatureModule.BRIDGE, featureConfig);
        ...
        ConfiguredFeature<?, ?> rotatedConfiguredFeature = new ConfiguredFeature<>(FeatureModule.BRIDGE, featureConfig.rotatedCopy());
